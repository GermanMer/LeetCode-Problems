...
class Solution:
    def letterCombinations(self, digits: str) -> list[str]:
        ...
        for digit in digits: # Iterar sobre cada dígito en la cadena de entrada
            ...
            new_combinations = [] # Crear una lista temporal para almacenar las nuevas combinaciones
            for prefix in combinations: # Iterar sobre cada combinación actual existente en 'combinations'
                for letter in letters: # Iterar sobre cada letra correspondiente al dígito actual
                    new_combinations.append(prefix + letter) # Añadir la nueva combinación (prefix + letter) a la lista temporal
            combinations = new_combinations # Actualizar 'combinations' con las nuevas combinaciones generadas
